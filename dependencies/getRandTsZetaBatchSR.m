function [vecMaxRandD,cellRandDiff,cellRandT] = getRandTsZetaBatchSR(vecPseudoT,vecPseudoTrace,vecEventT,dblUseMaxDur,dblJitterSize,intBatchSize,boolUseParallel)
