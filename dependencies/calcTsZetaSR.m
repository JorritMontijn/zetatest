function [vecRefT,vecRealDiff,vecRealFrac,vecRealFracLinear,matRandDiff,dblZetaP,dblZETA,intZETALoc] = ...
		calcTraceZetaSR(vecTraceT,vecTraceAct,vecEventStarts,dblSamplingInterval,dblUseMaxDur,intResampNum,boolDirectQuantile,dblJitterSize)
	...
	[vecRealDiff,vecRealFrac,vecRealFracLinear,vecRefT] = ...
		getTraceOffsetSR(vecPseudoTime,vecPseudoData,vecPseudoStartT',[],dblUseMaxDur);
	...
	try
		parfor intResampling=1:intResampNum
			...
			%get temp offset
			vecRandDiff = getTraceOffsetSR(vecPseudoTime,vecPseudoData,vecStimUseOnTime,vecRefT,dblUseMaxDur);
